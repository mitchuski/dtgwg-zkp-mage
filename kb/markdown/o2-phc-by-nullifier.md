---
title: "O2 — PHC by Nullifier"
section: "explorations"
source: "explorations/O2-phc-by-nullifier.md"
...
[Lab — circom-gadget](lab-circom-gadget.md) 8/8 with real groth16 proofs: Poseidon/BN254, depth-20
...
Lab-only trusted setup (not a production ceremony). **M5 DONE** — [Semaphore v4 Crosscheck](semaphore-v4-crosscheck.md) (this
...
- [Lab — 01-uniqueness-nullifier](lab-01-uniqueness-nullifier.md) — zero-dep reference model, **9/9 property
...
- Lineage: privacy-pools / mana-pools nullifier discipline (see O6 in [O5 O6 O8 — Supporting Notes](o5-o6-o8-supporting.md)).
