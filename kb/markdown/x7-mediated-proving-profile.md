---
title: "X7 — Mediated Proving Profile"
section: "explorations"
source: "explorations/X7-mediated-proving-profile.md"
...
**Register:** new (X-series; completes X4's deferred budget row — [Lab — quiet-presentation](lab-quiet-presentation.md) tier
property 6 defers the mediated path here) · leverage 🟠 · **Ladder:** reference built 2026-07-18 —
[Lab — mediator](lab-mediator.md) 9/9: T2 unbuildable at the constructor, P-ISOLATE/P-FORGET
...
- [Lab — quiet-presentation](lab-quiet-presentation.md) (8/8) — tier property 6 ("mediated path, where
