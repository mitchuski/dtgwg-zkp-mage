...
**Task force members, start here:** `./THE-WORK-SO-FAR.md` is the
4-minute human summary. Point your AI assistant at `./AGENTS.md` (its
introduction to this knowledge base) and `./PATH-MAP.md` (the research
