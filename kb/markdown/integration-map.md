...
- Land E1–E7 (`STRAWMAN-COHERENCE-EDITS.md`) into `proof-of-liveness-requirements.md` via PR/issues —
  now framed by [Decision — Overview](decision-overview.md) (the decision baseline; its §28 lists the ten
...
- Build order per [Explorations Index](explorations.md): boundary records first (§25 gate posture), then the shared
