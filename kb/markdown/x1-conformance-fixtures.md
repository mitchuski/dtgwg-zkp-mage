---
title: "X1 — Conformance Fixtures"
section: "explorations"
source: "explorations/X1-conformance-fixtures.md"
...
reference at **v2** 2026-07-18 — [Lab — fixtures](lab-fixtures.md) 13/13; reason register v2 =
...
[Lab — consumer-py](lab-consumer-py.md) 6/6: a stdlib-only Python consumer, no shared code, consumes all 39 vectors
...
- [Lab — 01-uniqueness-nullifier](lab-01-uniqueness-nullifier.md) — 9/9 properties; P4 self-Sybil is a ready-made
  §26.1 negative vector; P2/P5 are the cross-context class; versioned domain tag `dtg-zkp/nullifier/v0`.
- [Lab — 07-trust-graph-formation](lab-07-trust-graph-formation.md) — 11/11; G1–G7 are seven named rejections
