---
title: "Workflow — Workbench and Research Root"
section: "root"
source: "WORKFLOW.md"
...
**(4) Integrate.** Explorations also project outward into the corpus via [Integration Map](integration-map.md)
...
- **[Decision — Overview](decision-overview.md)** — stays here while it iterates (v0.1.0-draft). Its own
