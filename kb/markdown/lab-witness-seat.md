...
Source design: [VWC — Witness Seat](vwc-witness-seat.md). This build
...
lives in [Lab — witness-seat](lab-witness-seat.md), imports rt07's `joinCommunity` / `Swordsman` / `Mage` /
...
- Design doc: [VWC — Witness Seat](vwc-witness-seat.md) (M1–M4; this
