...
The **Semaphore v4 cross-check** (O2 M5, `explorations/SEMAPHORE-V4-CROSSCHECK.md` in the
...
- ~~**Semaphore v4 cross-check = O2 M5**~~ — **DONE 2026-07-18**
  (`explorations/SEMAPHORE-V4-CROSSCHECK.md`, research root); its one accidental-gap finding
...
- **npm deviation (recorded per lab rule):** the lab's reference models are zero-dep; a
  ...
  `runtimes/circom-gadget/` (own `package.json`, own `node_modules/`); everything else in the
