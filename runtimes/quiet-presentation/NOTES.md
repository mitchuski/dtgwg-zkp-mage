...
*Lab model of X4's design layer (research root: `dtgwg-cred-spec-main_mage/explorations/X4-observable-event-minimisation.md`). Reference model of the decision rules over event traces — not real networking, not crypto.*
...
- **Research root:** `dtgwg-cred-spec-main_mage/explorations/X4-observable-event-minimisation.md`
