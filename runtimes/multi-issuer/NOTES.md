...
(`dtgwg-cred-spec-main_mage/explorations/X8-multi-issuer-aggregation.md`):
...
- Design doc: `dtgwg-cred-spec-main_mage/explorations/X8-multi-issuer-aggregation.md`
  (M1 boundary record, M2 registry-profile note, M4 decision memo remain
  design-doc work; this runtime is M3).
- Decision doc: `predicate-assurance-boundary-decision.md` §12 (esp. 12.4,
