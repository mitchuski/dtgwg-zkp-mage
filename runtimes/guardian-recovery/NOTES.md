...
(`~/dtgwg-cred-spec-main_mage/explorations/X9-guardian-recovery.md`) at milestones
...
routine rotation stays in `runtimes/rotation` and never touches them.
...
X9's M1 says "guardian-set commitment + t-of-n check **in `runtimes/rotation`**
...
its own directory, `runtimes/guardian-recovery/`, and IMPORTS the neighbours unchanged:
...
Design doc: `~/dtgwg-cred-spec-main_mage/explorations/X9-guardian-recovery.md`.
