...
**Ladder:** reference built 2026-07-18 — `~/dtgwg-zkp-tf-mage/runtimes/rotation/` 10/10: routine
...
- Runtime 01 (`~/dtgwg-zkp-tf-mage/runtimes/01-uniqueness-nullifier/`) — the construction being recovered:
...
- Pools lineage (O6 in `O5-O6-O8-supporting.md`): one-way domain-separated key derivation for rotation is
