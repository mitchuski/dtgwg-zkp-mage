...
| WG-13 | direction | Cryptographic Background | move the chapter to the companion implementation guide when the core/guide split happens; it stays for now as context beside the records | editors' direction; the chair's Round 1 position (21 Sept) is to move it — scheduled with the core/guide split after Round 1 |
