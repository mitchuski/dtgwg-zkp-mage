...
>
> **Runtime traces:**
> - `runtimes/circom-gadget/` — the circuit; build + run per `CIRCUITS.md` (local circom toolchain required)
> - `explorations/` — the O-series + X1–X9 design docs the circuit closed
> - `predicate-assurance-boundary-decision.md` — the §25 statement-before-construction gate this build lived
> - `runtimes/fixtures/` — the 95-entry rejection-reason register; `node test.mjs`
...
**Scope:** the shared circom gadget (`runtimes/circom-gadget/`) — Poseidon
...
(`explorations/`, O-series + X1–X9), the decision baseline
(`predicate-assurance-boundary-decision.md`), the TF briefing draft, and the 2026-07-16 dream-cycle
