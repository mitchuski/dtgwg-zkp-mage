# G · zkp-tf #18 — seed set update: twelve construction records, the four #39/#40 work items placed
chip: AFTER H · FOLLOW-UP TO A (POSTED 08-29)
thread: https://github.com/trustoverip/dtgwg-zkp-tf/discussions/18
note: A (posted 08-29) proposed the linked-entry format. This says the format is now the record form in the specification repository, lists what grew, and points the board at it. Short.
ledger: 23
proverb: The board grows only where the book has already written; each row was a page first.
---
